...
EXTRA_VARS ?= ENVIRONMENT="$(ENVIRONMENT)" TF_HTTP_USERNAME="$(TF_HTTP_USERNAME)" TF_HTTP_PASSWORD="$(TF_HTTP_PASSWORD)" BASE_PATH="$(BASE_PATH)" GITLAB_PROJECT_ID="$(GITLAB_PROJECT_ID)" TF_ROOT_DIR="$(TF_ROOT_DIR)" TF_ROOT_DIR="$(TF_ROOT_DIR)" TF_HTTP_ADDRESS="$(TF_HTTP_ADDRESS)" TF_HTTP_LOCK_ADDRESS="$(TF_HTTP_LOCK_ADDRESS)" TF_HTTP_UNLOCK_ADDRESS="$(TF_HTTP_UNLOCK_ADDRESS)" PLAYBOOKS_ROOT_DIR="$(PLAYBOOKS_ROOT_DIR)" ANSIBLE_CONFIG="$(ANSIBLE_CONFIG)" ANSIBLE_COLLECTIONS_PATHS="$(ANSIBLE_COLLECTIONS_PATHS)"
